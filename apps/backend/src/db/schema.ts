...
export const merchantPlans = pgTable("merchant_plans", {
  ...
  annualPrice: decimal("annual_price").default("0"),
  annualDiscountPercent: integer("annual_discount_percent").default(0),
  ...
  maxOrdersPerMonth: integer("max_orders_per_month").default(100),
  transactionFee: decimal("transaction_fee").default("0"),
  includesCustomDomain: boolean("includes_custom_domain").default(false),
  includesApiAccess: boolean("includes_api_access").default(false),
  includesWhiteLabel: boolean("includes_white_label").default(false),
...
export const productVariantOptions = pgTable("product_variant_options", {
  ...
  index("product_variant_options_variant_id_idx").on(table.variantId),
]);
...
export const shippingRates = pgTable("shipping_rates", {
  ...
  index("shipping_rates_store_id_idx").on(table.storeId),
...
export const taxRates = pgTable("tax_rates", {
  ...
  index("tax_rates_store_id_idx").on(table.storeId),
]);
...
export const returns = pgTable("returns", {
  ...
  index("returns_store_id_idx").on(table.storeId),
]);
