...
- Name: auth\login.spec.ts >> Dashboard Auth >> empty form shows validation errors
- Location: e2e\specs\auth\login.spec.ts:39:3
...
Locator: locator('input#email[aria-invalid="true"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input#email[aria-invalid="true"]')
