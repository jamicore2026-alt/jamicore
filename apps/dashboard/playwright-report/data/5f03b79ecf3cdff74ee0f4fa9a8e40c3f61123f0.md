...
- Name: merchant\orders.spec.ts >> Orders Management >> clicking order navigates to detail
- Location: e2e\specs\merchant\orders.spec.ts:20:3
...
Call log:
  - waiting for locator('text=#ORD-001').first()
