	...
	<div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
		<div>
			<div class="flex items-center gap-2 mb-2">
				...
				<span class="text-[11px] font-mono uppercase tracking-widest text-primary">Stores</span>
			</div>
			<h1 class="text-3xl font-bold tracking-tight font-heading">All Stores</h1>
			<p class="text-muted-foreground mt-1 text-sm">Platform-wide store overview</p>
		</div>
	</div>

	<!-- Search -->
	<Card class="glass-card">
		<CardContent class="p-4 relative max-w-md">
			<Search class="absolute left-7 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
			<Input
