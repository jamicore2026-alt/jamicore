...
- Name: merchant\coupons.spec.ts >> Coupons Management >> can create a new coupon
- Location: e2e\specs\merchant\coupons.spec.ts:14:3
...
Call log:
  - waiting for getByRole('button', { name: 'Create Coupon' }).first()
