...
- Name: merchant\orders.spec.ts >> Orders Management >> can filter by status
- Location: e2e\specs\merchant\orders.spec.ts:15:3
...
Call log:
  - waiting for getByRole('button', { name: 'Delivered' })
