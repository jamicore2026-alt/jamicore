...
- Name: merchant\product-add.spec.ts >> Add Product >> shows error for missing required fields
- Location: e2e\specs\merchant\product-add.spec.ts:33:3
...
Call log:
  - waiting for getByRole('button', { name: 'Create Product' })
