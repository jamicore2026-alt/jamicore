...
- Name: merchant\product-add.spec.ts >> Add Product >> can create a new product
- Location: e2e\specs\merchant\product-add.spec.ts:15:3
...
Call log:
  - waiting for locator('input#titleEn')
