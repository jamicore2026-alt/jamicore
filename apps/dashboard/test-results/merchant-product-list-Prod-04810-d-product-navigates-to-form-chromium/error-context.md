...
- Name: merchant\product-list.spec.ts >> Product List >> clicking add product navigates to form
- Location: e2e\specs\merchant\product-list.spec.ts:25:3
...
Call log:
  - waiting for getByRole('link', { name: 'Add Product' })
