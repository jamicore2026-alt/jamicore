...
type LayoutRouteId = RouteId | "/" | "/cart" | "/checkout" | "/menu" | "/menu/[id]" | "/store/[slug]/brio" | "/store/[slug]/brio/cart" | "/store/[slug]/brio/checkout" | "/store/[slug]/brio/contact" | "/store/[slug]/brio/menu" | "/store/[slug]/brio/menu/[catId]" | "/store/[slug]/brio/product/[prodId]" | null
type LayoutParams = RouteParams & { id?: string; slug?: string; catId?: string; prodId?: string }
