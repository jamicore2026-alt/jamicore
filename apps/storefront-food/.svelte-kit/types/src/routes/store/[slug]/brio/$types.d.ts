...
type LayoutRouteId = RouteId | "/store/[slug]/brio" | "/store/[slug]/brio/cart" | "/store/[slug]/brio/checkout" | "/store/[slug]/brio/contact" | "/store/[slug]/brio/menu" | "/store/[slug]/brio/menu/[catId]" | "/store/[slug]/brio/product/[prodId]"
type LayoutParams = RouteParams & { slug?: string; catId?: string; prodId?: string }
